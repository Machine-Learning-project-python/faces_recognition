...
imagen_einstein = face_recognition.load_image_file("./images/einstein.jpg")
imagen_paul = face_recognition.load_image_file("./images/paul.jpg")
imagen_planck = face_recognition.load_image_file("./images/planck.jpg")
 
 
#Extraer los 'encodings' de cada imagen.
...
img = face_recognition.load_image_file('./images/imagen_input2.jpg')
